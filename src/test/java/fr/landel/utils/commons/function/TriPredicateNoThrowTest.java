...
/**
 * Check {@link TriPredicateNoThrow}
 *
 * @since Jan 25, 2018
 * @author Gilles
 *
 */
public class TriPredicateNoThrowTest {
    ...
    private static final TriPredicateNoThrow<String, String, Integer, IllegalArgumentException> P1 = (s1, s2, i) -> {
    ...
    private static final TriPredicateNoThrow<String, String, Integer, IllegalArgumentException> P2 = (s1, s2, i) -> {
    ...
    /**
     * Test method for
     * {@link TriPredicateNoThrow#test(java.lang.Object, java.lang.Object)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link TriPredicateNoThrow#testThrows(java.lang.Object, java.lang.Object)}.
     */
    @Test
    ...
    /**
     * Test method for {@link TriPredicateNoThrow#and(TriPredicateNoThrow)}.
     */
    @Test
    public void testAnd() {
        final TriPredicateNoThrow<String, String, Integer, IllegalArgumentException> pp = P1.and(P2);
    ...
    /**
     * Test method for {@link TriPredicateNoThrow#negateThrows()}.
     */
    @Test
    public void testNegateThrows() {
        final TriPredicateNoThrow<String, String, Integer, IllegalArgumentException> pp = P1.negateThrows();
    ...
    /**
     * Test method for {@link TriPredicateNoThrow#or(TriPredicateNoThrow)}.
     */
    @Test
    public void testOr() {
        final TriPredicateNoThrow<String, String, Integer, IllegalArgumentException> pp = P1.or(P2);
