...
/**
 * Check {@link HeptaPredicateNoThrow}
 *
 * @since Nov 18, 2017
 * @author Gilles
 *
 */
public class HeptaPredicateNoThrowTest {
    ...
    private static final HeptaPredicateNoThrow<String, String, Integer, String, String, String, String, IllegalArgumentException> P1 = (s1,
            s2, i, s3, s4, s5, s6) -> {
    ...
    private static final HeptaPredicateNoThrow<String, String, Integer, String, String, String, String, IllegalArgumentException> P2 = (s1,
            s2, i, s3, s4, s5, s6) -> {
    ...
    /**
     * Test method for
     * {@link HeptaPredicateNoThrow#test(java.lang.Object, java.lang.Object)}.
     */
    @Test
    public void testTest() {
        ...
        assertFalse(P1.test(null, "v2", 1, "turbo", "t", "u", "r"));
    }

    /**
     * Test method for
     * {@link HeptaPredicateNoThrow#testThrows(java.lang.Object, java.lang.Object)}.
     */
    @Test
    ...
    /**
     * Test method for {@link HeptaPredicateNoThrow#and(HeptaPredicateNoThrow)}.
     */
    @Test
    public void testAnd() {
        final HeptaPredicateNoThrow<String, String, Integer, String, String, String, String, IllegalArgumentException> pp = P1.and(P2);
    ...
    /**
     * Test method for {@link HeptaPredicateNoThrow#negateThrows()}.
     */
    @Test
    public void testNegateThrows() {
        final HeptaPredicateNoThrow<String, String, Integer, String, String, String, String, IllegalArgumentException> pp = P1
                .negateThrows();
    ...
    /**
     * Test method for {@link HeptaPredicateNoThrow#or(HeptaPredicateNoThrow)}.
     */
    @Test
    public void testOr() {
        final HeptaPredicateNoThrow<String, String, Integer, String, String, String, String, IllegalArgumentException> pp = P1.or(P2);
