...
public abstract class AbstractNona<A, B, C, D, E, F, G, H, I> implements Comparable<AbstractNona<A, B, C, D, E, F, G, H, I>>, Serializable {
    ...
    /**
     * <p>
     * Gets the first element from this nona.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the second element from this nona.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the third element from this nona.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the fourth element from this nona.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the fifth element from this nona.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the sixth element from this nona.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the seventh element from this nona.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the eighth element from this nona.
     * </p>
     *
     * @return the eighth element, may be null
     */
    public abstract H getEighth();

    /**
     * <p>
     * Gets the ninth element from this nona.
     * </p>
     *
     * @return the ninth element, may be null
     */
    public abstract I getNinth();

    /**
     * <p>
     * Compares the nona based on the first element followed by the second, the
     * third, the fourth, the fifth, the sixth, the seventh, the eighth and the
     * ninth element. The types must be {@code Comparable}.
     * </p>
     * 
     * @param other
     *            the other nona, not null
     ...
     */
    @Override
    public int compareTo(final AbstractNona<A, B, C, D, E, F, G, H, I> other) {
        if (other == null) {
        ...
        return new CompareToBuilder()
                ...
                .append(this.getEighth(), other.getEighth())
                .append(this.getNinth(), other.getNinth())
                .toComparison();
        // @formatter:on
    }
    ...
    /**
     * <p>
     * Compares this nona to another based on the nine elements.
     * </p>
     * 
     * @param obj
     *            the object to compare to, null returns false
     * @return true if the elements of the nona are equal
     */
    @Override
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof AbstractNona<?, ?, ?, ?, ?, ?, ?, ?, ?>) {
            final AbstractNona<?, ?, ?, ?, ?, ?, ?, ?, ?> other = (AbstractNona<?, ?, ?, ?, ?, ?, ?, ?, ?>) obj;
            // @formatter:off
    ...
    /**
     * <p>
     * Returns a String representation of this nona using the format
     * {@code ($first,$second,$third,$fourth,$fifth,$sixth,$seventh,$eighth,$ninth)}.
     * </p>
     * 
    ...
    public String toString() {
        ...
        return new StringBuilder()
                ...
                .append(this.getEighth()).append(',')
                .append(this.getNinth()).append(')')
                .toString();
     // @formatter:on
    }
     ...
     * 
     * <p>
     * This uses {@link java.util.Formattable} to perform the formatting. Eight
     ...
     * {@code (%1$s,%2$s,%3$s,%4$s,%5$s,%6$s,%7$s,%8$s,%9$s)}.
     * </p>
     * 
     * @param format
     *            the format string, optionally containing {@code %1$s},
     *            {@code %2$s}, {@code %3$s}, {@code %4$s}, {@code %5$s},
     *            {@code %6$s}, {@code %7$s}, {@code %8$s} and {@code %9$s}, not
     *            null
