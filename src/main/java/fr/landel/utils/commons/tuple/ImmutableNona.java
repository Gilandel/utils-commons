 ...
 * 
 * <p>
 * An immutable nona consisting of eight {@code Object} elements.
 * </p>
 * 
 * <p>
 * Although the implementation is immutable, there is no restriction on the
 * objects that may be stored. If mutable objects are stored in the nona, then
 * the nona itself effectively becomes mutable. The class is also {@code final},
 * so a subclass can not add undesirable behaviour.
 * </p>
 * 
 * <p>
 * #ThreadSafe# if all nona objects are thread-safe
 * </p>
 *
 * @param <A>
 ...
 *
 */
public final class ImmutableNona<A, B, C, D, E, F, G, H, I> extends AbstractImmutableNona<A, B, C, D, E, F, G, H, I> {

    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = -2105706642422589044L;

    /**
     * Create a new immutable nona instance.
     *
     * @param first
     ...
     */
    public ImmutableNona(final A first, final B second, final C third, final D fourth, final E fifth, final F sixth, final G seventh,
