...
public abstract class AbstractOcto<A, B, C, D, E, F, G, H> implements Comparable<AbstractOcto<A, B, C, D, E, F, G, H>>, Serializable {
    ...
    /**
     * <p>
     * Gets the first element from this octo.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the second element from this octo.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the third element from this octo.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the fourth element from this octo.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the fifth element from this octo.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the sixth element from this octo.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the seventh element from this octo.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the eighth element from this octo.
     * </p>
     *
     ...
     */
    @Override
    public int compareTo(final AbstractOcto<A, B, C, D, E, F, G, H> other) {
        if (other == null) {
    ...
    /**
     * <p>
     * Compares this octo to another based on the eight elements.
     * </p>
     * 
     * @param obj
     *            the object to compare to, null returns false
     * @return true if the elements of the octo are equal
     */
    @Override
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof AbstractOcto<?, ?, ?, ?, ?, ?, ?, ?>) {
            final AbstractOcto<?, ?, ?, ?, ?, ?, ?, ?> other = (AbstractOcto<?, ?, ?, ?, ?, ?, ?, ?>) obj;
            // @formatter:off
    ...
    /**
     * <p>
     * Returns a String representation of this octo using the format
     * {@code ($first,$second,$third,$fourth,$fifth,$sixth,$seventh,$eighth)}.
     * </p>
     * 
     ...
     *            {@code %6$s}, {@code %7$s} and {@code %8$s}, not null
