 ...
 *
 */
public abstract class AbstractPenta<A, B, C, D, E> implements Comparable<AbstractPenta<A, B, C, D, E>>, Serializable {

    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = -7319128872551221846L;

    /**
     * <p>
     * Gets the first element from this penta.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the second element from this penta.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the third element from this penta.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the fourth element from this penta.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the fifth element from this penta.
     * </p>
     *
    ...
    /**
     * <p>
     * Compares the penta based on the first element followed by the second, the
     * third, the fourth and the fifth element. The types must be
     * {@code Comparable}.
     * </p>
     * 
     * @param other
     *            the other penta, not null
     ...
     */
    @Override
    public int compareTo(final AbstractPenta<A, B, C, D, E> other) {
        if (other == null) {
    ...
    /**
     * <p>
     * Compares this penta to another based on the five elements.
     * </p>
     * 
     * @param obj
     *            the object to compare to, null returns false
     * @return true if the elements of the penta are equal
     */
    @Override
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof AbstractPenta<?, ?, ?, ?, ?>) {
            final AbstractPenta<?, ?, ?, ?, ?> other = (AbstractPenta<?, ?, ?, ?, ?>) obj;
            // @formatter:off
    ...
    /**
     * <p>
     * Returns a String representation of this penta using the format
     ...
     * 
     * <p>
     * This uses {@link java.util.Formattable} to perform the formatting. Five
     ...
     * {@code (%1$s,%2$s,%3$s,%4$s,%5$s)}.
     * </p>
     * 
     * @param format
     *            the format string, optionally containing {@code %1$s},
     *            {@code %2$s}, {@code %3$s}, {@code %4$s} and {@code %5$s}, not
     *            null
