 ...
 * result. This is the nine-arity specialization of {@link Consumer}. Unlike
 * most other functional interfaces, {@link NonaConsumer} is expected to operate
 * via side-effects.
 *
 * <p>
...
public interface NonaConsumer<A, B, C, D, E, F, G, H, I> {
    ...
    /**
     * Returns a composed {@link NonaConsumer} that performs, in sequence, this
     ...
     * @return a composed {@link NonaConsumer} that performs in sequence this
     *         operation followed by the {@code after} operation
     * @throws NullPointerException
     *             if {@code after} is null
     */
    default NonaConsumer<A, B, C, D, E, F, G, H, I> andThen(
            final NonaConsumer<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I> after) {
