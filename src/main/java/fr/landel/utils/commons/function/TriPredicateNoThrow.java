...
/**
 * Represents a predicate (boolean-valued function) of three arguments that
 * doesn't throw exception. This is the three-arity/exception specialization of
 * {@link Predicate}.
 *
 * <p>
...
public interface TriPredicateNoThrow<T, U, V, E extends Throwable> extends TriPredicate<T, U, V> {
     ...
     *             On error exception
     */
    default TriPredicateNoThrow<T, U, V, E> and(final TriPredicateNoThrow<T, U, V, E> other) throws E {
     ...
     *             On error exception
     */
    default TriPredicateNoThrow<T, U, V, E> negateThrows() throws E {
     ...
     *             On error exception
     */
    default TriPredicateNoThrow<T, U, V, E> or(final TriPredicateNoThrow<T, U, V, E> other) throws E {
        Objects.requireNonNull(other, "other");
