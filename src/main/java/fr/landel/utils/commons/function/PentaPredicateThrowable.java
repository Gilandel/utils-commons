 ...
 * This is the five-arity/exception specialization of {@link Predicate}.
 *
 * <p>
 ...
 */
@FunctionalInterface
public interface PentaPredicateThrowable<A, B, C, D, E, T extends Throwable> extends PentaPredicate<A, B, C, D, E>, Rethrower {
     ...
     *             On error exception
     */
    default PentaPredicateThrowable<A, B, C, D, E, T> and(final PentaPredicateThrowable<A, B, C, D, E, T> other) throws T {
     ...
     *             On error exception
     */
    default PentaPredicateThrowable<A, B, C, D, E, T> negateThrows() throws T {
     ...
     *             On error exception
     */
    default PentaPredicateThrowable<A, B, C, D, E, T> or(final PentaPredicateThrowable<A, B, C, D, E, T> other) throws T {
        Objects.requireNonNull(other, "other");
        return (a, b, c, d, e) -> testThrows(a, b, c, d, e) || other.testThrows(a, b, c, d, e);
    }
}
