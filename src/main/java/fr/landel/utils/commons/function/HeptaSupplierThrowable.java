...
/**
 * Represents a throwable supplier of seven results.
 *
 * <p>
 ...
 */
@FunctionalInterface
public interface HeptaSupplierThrowable<A, B, C, D, E, F, G, T extends Throwable> extends HeptaSupplier<A, B, C, D, E, F, G>, Rethrower {
     ...
     */
    @Override
    default Hepta<A, B, C, D, E, F, G> get() {
        try {
            return getThrows();
     ...
     *             On error exception
     */
    Hepta<A, B, C, D, E, F, G> getThrows() throws T;
}
