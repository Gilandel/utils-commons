...
/**
 * Represents a throwable predicate (boolean-valued function) of seven arguments
 * that doesn't throw exception. This is the seven-arity/exception
 ...
 */
@FunctionalInterface
public interface HeptaPredicateNoThrow<A, B, C, D, E, F, G, T extends Throwable> extends HeptaPredicate<A, B, C, D, E, F, G> {
     ...
     *             On error exception
     */
    default HeptaPredicateNoThrow<A, B, C, D, E, F, G, T> and(final HeptaPredicateNoThrow<A, B, C, D, E, F, G, T> other) throws T {
     ...
     *             On error exception
     */
    default HeptaPredicateNoThrow<A, B, C, D, E, F, G, T> negateThrows() throws T {
     ...
     *             On error exception
     */
    default HeptaPredicateNoThrow<A, B, C, D, E, F, G, T> or(final HeptaPredicateNoThrow<A, B, C, D, E, F, G, T> other) throws T {
        Objects.requireNonNull(other, "other");
        return (a, b, c, d, e, f, g) -> testThrows(a, b, c, d, e, f, g) || other.testThrows(a, b, c, d, e, f, g);
    }
}
