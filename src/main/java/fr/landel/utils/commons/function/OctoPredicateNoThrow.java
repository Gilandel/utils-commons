...
/**
 * Represents a throwable predicate (boolean-valued function) of eight arguments
 * that doesn't throw exception. This is the eight-arity/exception
 ...
 */
@FunctionalInterface
public interface OctoPredicateNoThrow<A, B, C, D, E, F, G, H, T extends Throwable> extends OctoPredicate<A, B, C, D, E, F, G, H> {
     ...
     *             On error exception
     */
    default OctoPredicateNoThrow<A, B, C, D, E, F, G, H, T> and(final OctoPredicateNoThrow<A, B, C, D, E, F, G, H, T> other) throws T {
     ...
     *             On error exception
     */
    default OctoPredicateNoThrow<A, B, C, D, E, F, G, H, T> negateThrows() throws T {
     ...
     *             On error exception
     */
    default OctoPredicateNoThrow<A, B, C, D, E, F, G, H, T> or(final OctoPredicateNoThrow<A, B, C, D, E, F, G, H, T> other) throws T {
        Objects.requireNonNull(other, "other");
        return (a, b, c, d, e, f, g, h) -> testThrows(a, b, c, d, e, f, g, h) || other.testThrows(a, b, c, d, e, f, g, h);
    }
}
