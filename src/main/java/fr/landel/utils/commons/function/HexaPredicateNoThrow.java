 ...
 * that doesn't throw exception. This is the six-arity/exception specialization
 * of {@link Predicate}.
 *
 * <p>
...
public interface HexaPredicateNoThrow<A, B, C, D, E, F, T extends Throwable> extends HexaPredicate<A, B, C, D, E, F> {
     ...
     *             On error exception
     */
    default HexaPredicateNoThrow<A, B, C, D, E, F, T> and(final HexaPredicateNoThrow<A, B, C, D, E, F, T> other) throws T {
     ...
     *             On error exception
     */
    default HexaPredicateNoThrow<A, B, C, D, E, F, T> negateThrows() throws T {
     ...
     *             On error exception
     */
    default HexaPredicateNoThrow<A, B, C, D, E, F, T> or(final HexaPredicateNoThrow<A, B, C, D, E, F, T> other) throws T {
        Objects.requireNonNull(other, "other");
        return (a, b, c, d, e, f) -> testThrows(a, b, c, d, e, f) || other.testThrows(a, b, c, d, e, f);
    }
}
